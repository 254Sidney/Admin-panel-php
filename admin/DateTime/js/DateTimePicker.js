...
}(function ($) 
{
	...
	var defaults = 
	{
		...
		addEventHandlers: null,  // addEventHandlers(oDateTimeOmnix)
	...
	function DateTimeOmnix(element, options)
	{
	...
	$.fn.DateTimeOmnix = function (options)
	{
		return this.each(function() 
		{
			$.removeData(this, "plugin_" + pluginName);
			if(!$.data(this, "plugin_" + pluginName))
				$.data(this, "plugin_" + pluginName, new DateTimeOmnix(this, options));
		});
	};

	DateTimeOmnix.prototype = {
		...
		_addEventHandlersForInput: function()
		{
			...
			$(oArrElements).not('input').click(function(e)
			{
				...
				{
					dtPickerObj.showDateTimeOmnix(this);
				}
			});
		...
		_inputFieldFocus: function(e)
		{
			...
			if(dtPickerObj.dataObject.oInputElement == null)
			{
				dtPickerObj.showDateTimeOmnix(e.target);
			}
		...
		// Public Method
		showDateTimeOmnix: function(oElement)
		{
			var dtPickerObj = this;
		...
		_hidePicker: function(iDuration)
		{
			...
			$(document).unbind("click.DateTimeOmnix");
			$(document).unbind("keydown.DateTimeOmnix");
			$(document).unbind("keyup.DateTimeOmnix");
		...
		_addEventHandlersForPicker: function()
		{
			...
			$(document).on("click.DateTimeOmnix", function(e)
			{
				dtPickerObj._hidePicker("");
			});

			$(document).on("keydown.DateTimeOmnix", function(e)
			{
